...
# Define the path where .wav files are located
wav_directory = "C:/Users/Vivek Vasani/Desktop/voice-style-learner/data/preprocessed_audio"

# Define the output file name
output_file = os.path.join(wav_directory, "list.txt")

# Define the range of .wav files (1 to 165)
wav_files_range = range(1, 12)
